...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView yetToUploadTextView, pendingTextView, rejectedTextView, completedTextView, statusTitleTextView, uploadTitleTextView, taskDescriptionTextView, taskTitleTextView, taskPointsTextView;
    ...
    private String imageName, taskName, colorCode, taskDaysLeft, taskDescription, taskStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        taskTitleTextView.setText(taskName);
